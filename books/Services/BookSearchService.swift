...
class BookSearchService: ObservableObject {
    ...
    func search(query: String) async -> Result<[BookMetadata], BookError> {
        ...
        // Debug logging
        print("🔍 BookSearchService: Starting search for query: '\(trimmedQuery)'")
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "printType", value: "books"), // Only return books
            URLQueryItem(name: "langRestrict", value: "en") // English results for now
        ]
        ...
        do {
            ...
            configuration.timeoutIntervalForRequest = 15.0 // Increased timeout
            ...
            if let jsonString = String(data: data, encoding: .utf8) {
                ...
                print("📊 BookSearchService: Response data: \(jsonString)")
            }
