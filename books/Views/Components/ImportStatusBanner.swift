...
struct ImportStatusBanner: View {
    ...
    var body: some View {
        Group {
            if shouldShowSkeleton {
                ...
                errorBanner
            } else if shouldShowImportBanner {
                importBanner
            }
        }
        .onAppear {
    ...
    private var shouldShowSkeleton: Bool {
        isConnecting && importService == nil
    }
    ...
    private var shouldShowImportBanner: Bool {
        guard let service = importService else { return false }
        return service.isImporting && service.importProgress != nil
    }
    ...
    private var skeletonBanner: some View {
        SkeletonImportBanner()
            .progressiveGlassEffect(material: .regular, level: .full)
    }
