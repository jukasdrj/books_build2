...
// MARK: - Unified Theme Preview Card for iOS 26 Bridge

struct UnifiedThemePreviewCard: View {
    @Environment(\.appTheme) private var currentTheme
    let theme: UnifiedThemeVariant
    let isSelected: Bool
    let onSelect: () -> Void
    ...
    private var themePreviewSection: some View {
        HStack(spacing: Theme.Spacing.sm) {
            // Use the previewGradient from UnifiedThemeVariant
